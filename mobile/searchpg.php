...
<html>
<head>
<title>Search Results - StatsCryptoMarket.com</title>
 <meta charset="utf-8">
...
<div class="popup" onclick="myFunction()">
  <span class="popuptext" id="myPopup">Bitcoin Added</span>
</div>
<div id="popupty" class="popupt">

  <div class="container innerpopupt" >
    <div class="titlepopup"><p>Add to Portfolio</p></div>
	  <h3 id="nameprompt" style="color: white;">Bitcoin</h3>
       <div class="center">
        <p id="priceprompt" style="color: white;">Current price: 1000$</p>
   ...
   <button type="button" class="btn btn-primary " onclick='addtoportfolio()' style="width: 100%;" ><span class="glyphicon glyphicon-ok"></span></button>
    ...
    <button type="button" class="btn btn-primary col-xs-12" onclick='closeprompt()'><span class="glyphicon glyphicon-remove"></span></button>
...
function searchcoin($inputsearch)
{
		global $results;
		global $none_found;
		...
		$numcoins = 0;
			...
			for($i = 0; $i < $totalpages; $i++){
				...
				foreach($tempdata['data'] as $value) {
					if (stripos($value["name"], $inputsearch) !== false){
...
<div id="cryptinflun">
 ...
 <div id="gads2" style="margin: 0 auto; text-align:center; background-color: #0e1116; width: 100%;">

 </div>
	 
<div  id="searchtitle" style="border-bottom: 1px solid #2d3849;">
	<div  style="width: 100%; height: 100px;  background: #0e1116;">
		<p style=" font-size: 24px; font-style: italic; text-align: center; color: white; line-height: 100px; vertical-align: middle; ">Search Results for <strong><a class="searchcol">&quot;<?php echo $searchquery; ?>&quot;</a></strong>:</p>
	</div>
</div>


 <div id="gads" style="float:none;margin:0px 0 0px 0;text-align:center;  background-color: #0e1116;  width: 100%;">
...
<div id="outtertable" class="table-responsive thistablu">
	<table id="customers" class="js-sort-table table tabulart borderless table-hover table-condensed">
		...
		<button  id="homebtn" class="navbuttontable" >Home</button>
		</div>

</div>

<script> var totalpaget = <?php echo $totalpages2; ?>; var ok = <?php echo intval(isset($_GET['page'])); ?>; var none_found = <?php echo $none_found;?>; </script>
<script src="../js/searchg.js" type="text/javascript"></script>
