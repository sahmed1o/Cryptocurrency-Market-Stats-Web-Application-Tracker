...
<html>
<head>
<title>Message Successful - StatsCryptoMarket.com</title>
  <meta charset="utf-8">
...
<div id="cryptinflun">
	...
	<!-- Intro Section that describes the company -->
    <div class="container ct-section" style="margin-top:80px;" id="welcome">
			<img src="img/mailsent.png" alt="mail sent" style="width:180px;height:180px; display: block; margin: 0 auto;"> 
            <h2 class="text-center text-info" style="color:white !important;">Your message has been sent, we will get back to you shortly.</h2>
		</div>
	<!-- End of Intro Section -->
<div id="navtabbtn" style="margin-top:20px;  margin-Bottom:60px !important;">
		<button  class="navbuttontable" onclick="location.href='contact';">Back</button>
		</div>
